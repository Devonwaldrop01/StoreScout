...
def test_verified_wire_429_is_counted_without_rewriting_historical_evidence(store):
    """Older wire evidence also contributes even when verification succeeded."""
