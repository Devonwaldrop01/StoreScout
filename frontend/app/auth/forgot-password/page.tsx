...
export default function ForgotPasswordPage() {
  ...
  const inputStyle = (field: string) => ({
    background: "var(--bg3)",
    border: `1px solid ${focusedField === field ? "rgba(255,178,36,.4)" : "var(--border)"}`,
    color: "var(--text)",
    ...
    <div className="relative min-h-screen flex items-center justify-center p-4" style={{ background: "var(--bg)" }}>
      ...
      <div className="relative w-full max-w-sm" style={{ zIndex: 1 }}>
        ...
        <div className="flex items-center justify-center gap-3 mb-8">
          <div style={{ width: "32px", height: "32px", borderRadius: "12px", background: "var(--accent)", boxShadow: "0 0 20px rgba(255,178,36,.4)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
            <Zap style={{ width: "16px", height: "16px", color: "var(--ink)" }} />
          </div>
        ...
        {done ? (
          ...
          >
            ...
            <div className="mt-6 flex flex-col gap-2">
              <Link
                href="/auth/login"
                className="block w-full py-2.5 rounded-md text-sm font-semibold text-center transition-all hover:brightness-110"
